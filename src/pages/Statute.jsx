...
export const Statute = () => {
  ...
  const sections = [
    { title: t("statute.section1Title"), content: t("statute.section1Content") },
    { title: t("statute.section2Title"), content: t("statute.section2Content") },
    { title: t("statute.section3Title"), content: t("statute.section3Content") },
    { title: t("statute.section4Title"), content: t("statute.section4Content") },
    { title: t("statute.section5Title"), content: t("statute.section5Content") },
